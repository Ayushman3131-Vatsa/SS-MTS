...
import type { OfferingCatalogItem, OfferingCreatePayload, OfferingUpdatePayload } from "../model/offerings";
...
export const offeringsApi = {
  list: async (signal?: AbortSignal): Promise<OfferingCatalogItem[]> =>
    parse(z.array(offeringSchema), await apiRequest<unknown>("/offerings", { signal })),
