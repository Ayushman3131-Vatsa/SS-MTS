...
export const TaskProjectsPage = () => {
  ...
  return <div className={styles.content}>
    <PageHeading eyebrow="Task Management" title="Projects" description="Plan, staff and track every delivery workspace." actions={canCreateProject(principal.role) ? <Button type="button" className={styles.compactButton} onClick={() => setCreating(true)}><Plus size={14} /> New project</Button> : undefined} />
