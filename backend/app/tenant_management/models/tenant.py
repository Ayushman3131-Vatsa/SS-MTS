...
class Tenant(Base):
    ...
    __table_args__ = (
        ...
        UniqueConstraint("contact_email", name="uq_tenants_contact_email"),
        CheckConstraint(
    ...
    pan_number: Mapped[str | None] = mapped_column(String(100), nullable=True)
    ...
    alternate_contact_designation: Mapped[str | None] = mapped_column(String(100), nullable=True)
